...
public class Conversion {
    ...
    public HashMap<String, String[]> createOperatingHoursMap(JSONArray arr) throws JSONException {
        ...
        for (int i = 0; i < arr.length(); i++) {
            ...
            if (m.find()) {
                hours[0] = m.group(1).trim();
                hours[1] = m.group(2).trim();
            }
    ...
    public StringBuilder convertStoreJSONToCSV(JSONObject obj) throws JSONException {
